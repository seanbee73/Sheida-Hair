  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl md:text-5xl font-medium tracking-tight text-white mb-6 leading-[1.1] max-w-2xl aura-reveal">
        Meet our master colorists &amp; artists.
      </h2>
      <p className="text-sm text-zinc-400 font-light leading-relaxed max-w-2xl mb-12">
        Led by Master Colorist Sheida and Master Haircutter Haik, our close-knit team is united by a passion for damage-free blonding, precision geometric layering, and genuine hospitality.
      </p>
