      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-6">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-medium tracking-tight text-white leading-[1.1] max-w-2xl">
            Recent blondes, balayage &amp; precision cuts.
          </h2>
          <p className="text-sm text-zinc-400 font-light mt-3 max-w-xl">
            Real client transformations at Sheida Hair Studio. Click on any style to see the technique breakdown, hair diagnosis, and stylist details.
          </p>
        </div>
