    ...
    <>
      ...
      >
        ...
        <p className="text-sm md:text-base text-zinc-300 max-w-xl font-light mb-10 leading-relaxed">
          Toronto’s premier hair sanctuary specializing in <strong className="text-white font-medium">zero-damage blonde balayage</strong>, seamless foil highlights, precision haircuts with Master Stylist Haik, Milbon Japanese treatments, and revitalizing hair botox.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6 mb-16 w-full sm:w-auto">
          <a
            href="#booking"
            className="inline-flex items-center justify-center px-8 py-4 text-[10px] font-bold tracking-widest text-zinc-950 bg-[#d8b485] hover:bg-[#c2a277] transition-all uppercase text-center font-bold"
          >
            Book Appointment →
          </a>
          <a
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-white/10 text-left">
          <div className="p-4 bg-[#0c0c0e]/80 border border-white/5 backdrop-blur-sm">
            ...
            <p className="text-xs text-white font-medium">124 Willowdale Ave</p>
            <p className="text-[10px] text-zinc-500">North York (Free Plaza Parking)</p>
          </div>
          ...
          <div className="p-4 bg-[#0c0c0e]/80 border border-white/5 backdrop-blur-sm">
            ...
            <p className="text-xs text-white font-medium">10:00 AM – 7:00 PM</p>
            <p className="text-[10px] text-zinc-400 font-medium">Tuesday – Saturday</p>
          </div>
          ...
          <div className="p-4 bg-[#0c0c0e]/80 border border-white/5 backdrop-blur-sm">
            ...
            <p className="text-xs text-white font-medium">Zero-Damage Balayage</p>
            <p className="text-[10px] text-zinc-500">Bleach Strand Diagnostics</p>
          </div>
          ...
          <div className="p-4 bg-[#0c0c0e]/80 border border-white/5 backdrop-blur-sm">
            ...
            <p className="text-xs text-white font-medium">Nima's Artisan Coffee</p>
            <p className="text-[10px] text-zinc-500">Warm Persian Hospitality</p>
          </div>
        </div>
